									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="title">제목 <span class="must-mark">*</span></label>
													<input class="form-control" type="text" name="title"
														value="${noticeVO.title}" id="title">
												</div>
											</div>
										</div>
										<!-- end row -->
										<div class="row">
											<div class="form-group col-md-6">
												<label for="register" class="col-form-label">작성자<span
													class="must-mark">*</span></label> <input type="text"
													class="form-control" name="register" id="register"
													value="${noticeVO.register}" disabled="disabled">
											</div>

											<div class="form-group col-md-6">
												<label for="regDate" class="col-form-label">작성일자<span
													class="must-mark">*</span></label> <input type="text"
													class="form-control" name="regDate" id="regDate"
													data-toggle="date-picker" data-single-date-picker="true"
													value="${noticeVO.regDate}" disabled="disabled">
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-12">
												...
												<textarea class="form-control" name="content" id="content"
													rows="5">${noticeVO.content}</textarea>
											</div>
										</div>
										...
										<div>
											...
											<ul class="dropzone-previews clearfix uploadedList">
												...
												<c:forEach items="${noticeFileVO}" var="fVo" varStatus="status">
														...
														<div
															...
															<div class="p-2">
																<div class="row align-items-center">
																	<c:forTokens var="token" items="${noticeFileNo}" delims="." varStatus="status">
